...
export const SparklesIcon = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 21l-.813-5.096L3 15l5.096-.813L9 9l.813 5.187L15 15l-5.187.904Zm6.19-9.19L15 9l-.813-2.287L12 6l2.188-.813L15 3l.813 2.187L18 6l-2.003.714Z" />
  </svg>
);
...
export const TrashIcon = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.34 6m-2.52 0L11 9m4.735-3.51.56-1.486A.5.5 0 0 0 15.772 3H8.228a.5.5 0 0 0-.487.397L7.1 4.49m11.153 0A48.11 48.11 0 0 1 6 5.34m11.153-1.11-.56 1.486A.5.5 0 0 1 16.143 6H7.857a.5.5 0 0 1-.487-.397L6.8 4.49M15 9.75V18a2.25 2.25 0 0 1-2.25 2.25h-1.5A2.25 2.25 0 0 1 9 18v-8.25m6-3h-6" />
  </svg>
);
...
export const DragIcon = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
